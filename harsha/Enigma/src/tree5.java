...
public static ArrayList<String> gettingal1()
{
	String lastLine1=null;
	try
	{
	   
		 FileInputStream in = new FileInputStream("Q:/Eclipse Workspace/Enigma/finalstral2.txt");
		  ...
		  //System.out.println(lastLine1); Imp
