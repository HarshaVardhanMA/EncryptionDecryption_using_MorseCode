...
public class encode 
{
	...
	public static void main(String[] args)
	{
		...
		ArrayList<String> finalstral = new ArrayList<String>();
 		...
 		pw = new PrintWriter(new BufferedWriter(new FileWriter("F:/BE-PESIT/3rd sem/Projects/Morse Code/harsha/Enigma/finalstral2.txt",true)));
		 ...
		 try
	 		...
	 		pw = new PrintWriter(new BufferedWriter(new FileWriter("F:/BE-PESIT/3rd sem/Projects/Morse Code/harsha/Enigma/morsecombin.txt",true)));
